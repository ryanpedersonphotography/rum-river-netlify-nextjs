...
const navItems = [
    ...
    { linkText: 'Accessibility', href: '/components-demo/(demos)/accessibility-demo' },
    { linkText: 'Spacing Demo', href: '/components-demo/spacing-demo' },
    { linkText: 'Section Demo', href: '/components-demo/section-demo' },
    { linkText: 'Layout Demo', href: '/components-demo/(demos)/layout-demo' },
    { linkText: 'Layout Patterns', href: '/components-demo/(demos)/layout-patterns' },
